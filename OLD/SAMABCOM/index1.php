...
<body id="haut"><!--oncontextmenu="return false"-->
  ...
  <header class="nav-type-2">
      <div class="tr"> 
        ...
        <span class="td"> 
          <a href="https://twitter.com/samabcom" target="_blank"><i class="fa fa-twitter"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                  ...
                  <li class="dropdown">
                    <a href="#service"  >Services</a>
                     <ul class="dropdown-menu">
                      <li><a href="php/fb.php"> installation téléphonique et </br> raccordement de la FO </a></li>
                      <li><a href="php/elec.php">Eléctricité & Eclairage Public</a></li>
                      <li><a href="php/scr.php">Sécurité</a></li>
                      <li><a href="php/etd.php">Etude de projet</a></li>
                      <li><a href="php/gnv.php">Génie Civil</a></li>
                    </ul> 
                  </li>
                  <li class="dropdown">
          ...
          <div class="container">
            <div class="row" >
                ...
                <div class='box'>
                  ...
                  <div class="div_trst_img col-md-6 wow fadeInUp front face side face" data-wow-duration="1s" data-wow-delay="0.1s">
                    ...
                    <div class=" cta-button top_margin">
                      <a href="revolution/file/PRESENTATION SAMABCOM 01-03-2021.pdf" class="btn btn-lg btn-color " download="PRESENTATION SAMABCOM 01-03-2021.pdf" target="_blank">Télécharger la représentation<br/>de l'entreprise.</a>
                    </div>
                    </center>      
                  </div>
              ...
              <div class="col-md-6 promo-description">
                ...
                <a href="php/qsm.php" class="btn btn-lg btn-color">Lire Plus</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="section-wrap-mp pb-60" id="pr">
      <div class="container">
        <h2 class="text-center bottom-line trt">Nos partenaires</h2>
          ...
          <div align="center">
            <a href="php/pr.php" class="btn btn-lg btn-color">Voir plus</a> 
          </div>
        </div>    
      </div>
    </section> 
            ...
            <div class="features-icons mt-80">
              <div class="service-item-box icon-effect-1 icon-effect-1a">
                ...
                <div class="features-text">
                    <a href="php/fb.php">  <h6>Telecom</h6></a><br/>
      ...
      <div class="container">
        <h2 class="text-center bottom-line trt">Notre Galerie Photos</h2>
          <div class="row">
            ...
            <div align="center">
              <a href="php/galerie.php" class="btn btn-lg btn-color">Voir plus de photos</a>
            </div>
          </div>    
      </div>
    </section>
    ...
    <section class="section-wrap-mp contact" id="contact">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-8">
          <!-- contact table forme-->
          <form id="contact-form" action="php/tr-contact.php" method="post">
            ...
            <div class="row">
              ...
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="widget footer-links">
                  <h5>Liens utiles</h5>
                  <ul>
                    <li><a href="php/qsm.php">A propos </a></li>
                    <li><a href="php/service.php">Notre savoir faire</a></li>
                    <li><a href="php/qsm.php">Pourquoi Samabcom ?</a></li>
                    <li><a href="php/pr.php">Nos références</a></li>
                  </ul>
                </div>
                ...
                <div class="widget footer-posts last">
                  ...
                  <div class="footer-entry-list">
                    <div class="footer-entry">
                      <p>
                        <a href="php/pr.php">Réseau de télécomunication</a>
                      </p>
                      <span></span>
                    </div> <!-- end entry -->
                    <div class="footer-entry">
                      <p>
                        <a href="php/pr.php">Eclairage et dessert téléphonique</a>
                      </p>
                      <span></span>
                    </div> <!-- end entry -->
                    <div class="footer-entry">
                      <p>
                        <a href="php/pr.php">Eclairage et dessert (Cablage et GC)</a>
                      </p>
                      <span> </span>
                    </div> <!-- end entry -->
                     <div class="footer-entry">
                      <p>
                        <a href="php/pr.php">Installation téléphonique intérieure et extérieure</a>
                      </p>
                      <span> </span>
                    </div> 
                  </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-4 col-sm-offset-2 col-xs-12 footer-socials">
                <div class="social-icons clearfix right">
                  ...
                  <a href="https://plus.google.com" target="_blank"><i class="fa fa-google-plus"></i></a>
                  <a href="https://fr.linkedin.com" target="_blank"><i class="fa fa-linkedin"></i></a>
                  <a href="https://youtube.com" target="_blank"><i class="fa fa-vimeo"></i></a>
                </div>
              </div>
            </div>
          </div>
