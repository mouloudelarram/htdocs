    ...
    <div class="App">
        ...
        <div class="main">
            ...
            <div class="video">
                <div>
                    <h3>Welcome.</h3>
                    <video src="./M-learn/UDACITY-LEARN/full-Stack  Development Track/PYTHON-VIDEO/Python-3/1 - Python_ Welcome to strings_lists.mp4" autoplay controls muted></video>
                    <div class="history">
                        <h4>&larr; go back</h4>
