...
let linkVideo = "./M-learn/UDACITY-LEARN/full-Stack  Development Track/PYTHON-VIDEO/Python-3/1 - Python_ Welcome to strings_lists.mp4";
let lastIdVideo = "1 - Python_ Welcome to strings_lists.mp4";
let index = 1;
